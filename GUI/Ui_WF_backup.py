...
# Form implementation generated from reading ui file 'd:\NguyenCuong\PrintStamp_A204\GUI\WF_backup.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.txt_BoxLOT_PN = QtWidgets.QPlainTextEdit(self.formLayoutWidget_2)
        self.txt_BoxLOT_PN.setMinimumSize(QtCore.QSize(0, 35))
        self.txt_BoxLOT_PN.setMaximumSize(QtCore.QSize(16777215, 30))
        font = QtGui.QFont()
        font.setPointSize(-1)
        self.txt_BoxLOT_PN.setFont(font)
        self.txt_BoxLOT_PN.setStyleSheet("border: 1px solid #ccc; font-size: 14px;")
        self.txt_BoxLOT_PN.setObjectName("txt_BoxLOT_PN")
        self.FormInsert_BoxLOT.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.txt_BoxLOT_PN)
        self.txt_BoxLOT_DateCode = QtWidgets.QPlainTextEdit(self.formLayoutWidget_2)
        self.txt_BoxLOT_DateCode.setMinimumSize(QtCore.QSize(0, 35))
        self.txt_BoxLOT_DateCode.setMaximumSize(QtCore.QSize(16777215, 30))
        font = QtGui.QFont()
        font.setPointSize(-1)
        self.txt_BoxLOT_DateCode.setFont(font)
        self.txt_BoxLOT_DateCode.setStyleSheet("border: 1px solid #ccc; font-size: 14px;")
        self.txt_BoxLOT_DateCode.setObjectName("txt_BoxLOT_DateCode")
        self.FormInsert_BoxLOT.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.txt_BoxLOT_DateCode)
        ...
        self.FormInsert_BoxLOT.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.label_28)
        ...
        self.FormInsert_BoxLOT.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.txt_BoxLOT_DataPrint)
        self.txt_BoxLOT_SerialNo = QtWidgets.QPlainTextEdit(self.formLayoutWidget_2)
        self.txt_BoxLOT_SerialNo.setEnabled(False)
        self.txt_BoxLOT_SerialNo.setMinimumSize(QtCore.QSize(0, 35))
        self.txt_BoxLOT_SerialNo.setMaximumSize(QtCore.QSize(16777215, 30))
        font = QtGui.QFont()
        font.setPointSize(-1)
        self.txt_BoxLOT_SerialNo.setFont(font)
        self.txt_BoxLOT_SerialNo.setStyleSheet("border: 1px solid #ccc; font-size: 14px;")
        self.txt_BoxLOT_SerialNo.setObjectName("txt_BoxLOT_SerialNo")
        self.FormInsert_BoxLOT.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.txt_BoxLOT_SerialNo)
        ...
        self.label_21.setStyleSheet("c")
        self.label_21.setObjectName("label_21")
        self.FormInsert_BoxLOT.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.label_21)
        ...
        self.label_23.setStyleSheet("c")
        self.label_23.setObjectName("label_23")
        self.FormInsert_BoxLOT.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.label_23)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_22.setText(_translate("MainWindow", "FIT P/N"))
        self.label_28.setText(_translate("MainWindow", "Data Print"))
        self.label_21.setText(_translate("MainWindow", "Box serial No."))
        self.label_23.setText(_translate("MainWindow", "Date Code"))
