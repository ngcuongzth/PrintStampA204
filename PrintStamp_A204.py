...
class MyApplication(QMainWindow):
    def __init__(self):
        ...
        self.uic.checkbox_TestMode.stateChanged.connect(self.on_change_state_test_mode)
        self.uic.cb_symbols.addItems(stepcodes)
        self.uic.cb_symbols.currentIndexChanged.connect(self.on_change_index_TestMode)
    ...
    def on_change_index_TestMode(self):
        index = self.uic.cb_symbols.currentIndex()  # Lấy index của phần tử được chọn
        self.index_stepcode_test_2 = index
        if self.uic.checkbox_TestMode.isChecked():
            calc_number_stamp = 33 - self.index_stepcode_test_2
            self.uic.txt_numberStamp.setText(str(calc_number_stamp))
        print(f"Selected index: {self.index_stepcode_test_2}")
    ...
    def clear_data_form(self):
        ...
        self.index_stepcode_test_2 = 0
        self.uic.cb_symbols.setCurrentIndex(0)
        ...
        try:
            ...
            for i in range(number_stamp):
                ...
                if self.uic.checkbox_TestMode.isChecked() == False:
                    ...
                    if self.index_stepcode_test_2 < 33:
    ...
    def on_change_state_test_mode(self, state):
        if state == 2:
            self.uic.txt_numberStamp.setText("30")
        else:
            self.uic.txt_numberStamp.setText("1")
